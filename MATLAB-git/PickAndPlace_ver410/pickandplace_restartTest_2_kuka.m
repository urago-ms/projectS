...
% % % % %             pause(1);
            ...
            fposition3 = [0, 0.52, 1,	0,	0,	0];    % above place position
            fposition4 = [0, 0.52, 0.825,	0,	0,	0];   % place position
            ...
            [res_fpos4_setpos] = sim.simxSetObjectPosition(clientID, fpos4_DummyHandle, -1, [fposition4(1), fposition4(2), fposition4(3)], sim.simx_opmode_oneshot);
                        [res_fpos4_setpos] = sim.simxSetObjectPosition(clientID, fpos4_DummyHandle, -1, target_dummy_orien, sim.simx_opmode_oneshot);
