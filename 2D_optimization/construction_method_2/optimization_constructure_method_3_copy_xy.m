...
file_name = strcat(time,'_');
file_name = strcat(file_name,id_num_st);
file_name = strcat(file_name,'_InitialPosture.png');
...
for const_index = 0:4
    ...
    while 1
        ...
        for i = 1:search_range
            ...
            if neighbour_best_o_function == o_function(i,1)
                ...
                % center
                scatter(p_pos_x, p_pos_y, 'r', 'filled');
                hold on;
                ...
                plot(x1,y,'r','LineWidth',2.0)
                plot(x2,y,'r','LineWidth',2.0)
                ...
                % center
                scatter(current_m_pos_x, current_m_pos_y, 'b', 'filled');
                hold on;
                
                % horizontal line
                x = [current_m_pos_x - 1/2*ml current_m_pos_x + 1/2*ml];
                y1 = [current_m_pos_y - 1/2*ml current_m_pos_y - 1/2*ml];
                y2 = [current_m_pos_y + 1/2*ml current_m_pos_y + 1/2*ml];
                plot(x,y1,'b','LineWidth',2.0)
                plot(x,y2,'b','LineWidth',2.0)
                
                % vertical line
                x1 = [current_m_pos_x - 1/2*ml current_m_pos_x - 1/2*ml];
                x2 = [current_m_pos_x + 1/2*ml current_m_pos_x + 1/2*ml];
                y = [current_m_pos_y - 1/2*ml current_m_pos_y + 1/2*ml];
                plot(x1,y,'b','LineWidth',2.0)
                plot(x2,y,'b','LineWidth',2.0)
                
                
                % Manipulator movable range plot %%%%%%%%%%%%%%%%%%%%%%%%%%
                t = linspace(0,2*pi,100);
                cx = current_m_pos_x;   %center
                cy = current_m_pos_y;
                r = link_1 + link_2;    % radius
                plot(r*sin(t)+cx,r*cos(t)+cy,'b','LineWidth',2.0)
                hold on;
                
                plot(m_min_range*sin(t)+cx,m_min_range*cos(t)+cy,'b','LineWidth',2.0)
                %hold on;
                ...
                %%%%%%%%%%%%%%% Current Position IK %%%%%%%%%%%%%%%%%%%%%%
                %%%%% Inverse kinematics Solution 1 %%%%%%%%%%%%
                cos_alpha = (-((p_pos_x - current_m_pos_x)^2 + (p_pos_y - current_m_pos_y)^2) + link_1^2 + link_2^2) / (2*link_1*link_2);    % () of (2*link_1*link_2) is necessary
                alpha = atan2(sqrt(1 - cos_alpha*cos_alpha), cos_alpha);
                %alpha = atan2(sqrt(1-((-(p_pos_x - current_m_pos_x)^2 - (p_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2)^2), (-(p_pos_x - current_m_pos_x)^2 - (p_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2);
                c_ik_sol_1_theta_2 = pi - alpha;
                c_ik_sol_1_theta_1 = atan2((p_pos_y - current_m_pos_y), (p_pos_x - current_m_pos_x)) - atan2((link_2*sin(c_ik_sol_1_theta_2)), (link_1 + link_2*cos(c_ik_sol_1_theta_2)));
                %c_ik_sol_1_theta_1 = atan2((p_pos_y - current_m_pos_y), (p_pos_x - current_m_pos_x)) - atan2(link_2*sin(c_ik_sol_1_theta_2), link_1 + link_2*cos(c_ik_sol_1_theta_2))
                ...
                %alpha = atan2(sqrt(1-((-(p_pos_x - current_m_pos_x)^2 - (p_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2)^2), (-(p_pos_x - current_m_pos_x)^2 - (p_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2);
                c_ik_sol_2_theta_2 = pi - alpha;
                c_ik_sol_2_theta_1 = atan2((p_pos_y - current_m_pos_y), (p_pos_x - current_m_pos_x)) - atan2((link_2*sin(c_ik_sol_2_theta_2)), (link_1 + link_2*cos(c_ik_sol_2_theta_2)));
                %c_ik_sol_2_theta_1 = atan2((optimized_p_pos_y - current_m_pos_y), (optimized_p_pos_x - current_m_pos_x)) - atan2(link_2*sin(c_ik_sol_2_theta_2), link_1 + link_2*cos(c_ik_sol_2_theta_2))
                
                
                %%%%%%%%%%%%%%% Goal Position IK %%%%%%%%%%%%%%%%%%%%%%
                %%%%% Inverse kinematics Solution 1 %%%%%%%%%%%%
                cos_alpha = (-((c_pos_x - current_m_pos_x)^2 + (c_pos_y - current_m_pos_y)^2) + link_1^2 + link_2^2) / (2*link_1*link_2);    % () of (2*link_1*link_2) is necessary
                alpha = atan2(sqrt(1 - cos_alpha*cos_alpha), cos_alpha);
                %alpha = atan2(sqrt(1-((-(c_pos_x - current_m_pos_x)^2 - (c_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2)^2), (-(c_pos_x - current_m_pos_x)^2 - (c_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2);
                g_ik_sol_1_theta_2 = pi - alpha;
                g_ik_sol_1_theta_1 = atan2((c_pos_y - current_m_pos_y), (c_pos_x - current_m_pos_x)) - atan2((link_2*sin(g_ik_sol_1_theta_2)), (link_1 + link_2*cos(g_ik_sol_1_theta_2)));
                %g_ik_sol_1_theta_1 = atan2((c_pos_y - current_m_pos_y), (c_pos_x - current_m_pos_x)) - atan2(link_2*sin(g_ik_sol_1_theta_2), link_1 + link_2*cos(g_ik_sol_1_theta_2))
                ...
                %alpha = atan2(sqrt(1-((-(c_pos_x - current_m_pos_x)^2 - (c_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2)^2), (-(c_pos_x - current_m_pos_x)^2 - (c_pos_y - current_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2);
                g_ik_sol_2_theta_2 = pi - alpha;
                g_ik_sol_2_theta_1 = atan2((c_pos_y - current_m_pos_y), (c_pos_x - current_m_pos_x)) - atan2((link_2*sin(g_ik_sol_2_theta_2)), (link_1 + link_2*cos(g_ik_sol_2_theta_2)));
                %g_ik_sol_2_theta_1 = atan2((c_pos_y - current_m_pos_y), (c_pos_x - current_m_pos_x)) - atan2(link_2*sin(g_ik_sol_2_theta_2), link_1 + link_2*cos(g_ik_sol_2_theta_2))
                
                
                % % Forward kinematics (For confirmation)
                % X = link_1*cos(g_ik_sol_2_theta_1) + link_2*cos(g_ik_sol_2_theta_1 + g_ik_sol_2_theta_2)+current_m_pos_x
                % Y = link_1*sin(g_ik_sol_2_theta_1) + link_2*sin(g_ik_sol_2_theta_1 + g_ik_sol_2_theta_2)+current_m_pos_y
                % scatter(current_m_pos_x + link_1*cos(g_ik_sol_2_theta_1) + link_2*cos(g_ik_sol_2_theta_1 + g_ik_sol_2_theta_2), current_m_pos_y + link_1*sin(g_ik_sol_2_theta_1) + link_2*sin(g_ik_sol_2_theta_1 + g_ik_sol_2_theta_2), 'cyan', 'filled');
                ...
                %%%%% Current initial arm %%%%%%%%%%%%
                % link_1 plot
                joint_x1 = [current_m_pos_x current_m_pos_x + link_1*cos(c_initial_theta_1)];
                joint_y1 = [current_m_pos_y current_m_pos_y + link_1*sin(c_initial_theta_1)];
                plot(joint_x1,joint_y1,'Color',orange,'LineWidth',1.5)
                
                % link_2 plot
                joint_x2 = [current_m_pos_x + link_1*cos(c_initial_theta_1) current_m_pos_x + link_1*cos(c_initial_theta_1) + link_2*cos(c_initial_theta_1 + c_initial_theta_2)];
                joint_y2 = [current_m_pos_y + link_1*sin(c_initial_theta_1) current_m_pos_y + link_1*sin(c_initial_theta_1) + link_2*sin(c_initial_theta_1 + c_initial_theta_2)];
                plot(joint_x2,joint_y2,'Color',orange,'LineWidth',1.5)
                
                %%%%% Goal initial arm %%%%%%%%%%%%
                % link_1 plot
                joint_x1 = [current_m_pos_x current_m_pos_x + link_1*cos(g_initial_theta_1)];
                joint_y1 = [current_m_pos_y current_m_pos_y + link_1*sin(g_initial_theta_1)];
                plot(joint_x1,joint_y1,'Color',orange,'LineWidth',1.5)
                
                % link_2 plot
                joint_x2 = [current_m_pos_x + link_1*cos(g_initial_theta_1) current_m_pos_x + link_1*cos(g_initial_theta_1) + link_2*cos(g_initial_theta_1 + g_initial_theta_2)];
                joint_y2 = [current_m_pos_y + link_1*sin(g_initial_theta_1) current_m_pos_y + link_1*sin(g_initial_theta_1) + link_2*sin(g_initial_theta_1 + g_initial_theta_2)];
                plot(joint_x2,joint_y2,'Color',orange,'LineWidth',1.5)
    ...
    while 1
        ...
        for i = 1:search_range
            ...
            if neighbour_best_o_function == o_function(i,1)
                ...
                % center
                scatter(current_p_pos_x, current_p_pos_y, 'r', 'filled');
                hold on;
                
                % horizontal line
                x = [current_p_pos_x - 1/2*pl current_p_pos_x + 1/2*pl];
                y1 = [current_p_pos_y - 1/2*pl current_p_pos_y - 1/2*pl];
                y2 = [current_p_pos_y + 1/2*pl current_p_pos_y + 1/2*pl];
                plot(x,y1,'r','LineWidth',2.0)
                plot(x,y2,'r','LineWidth',2.0)
                
                % vertical line
                x1 = [current_p_pos_x - 1/2*pl current_p_pos_x - 1/2*pl];
                x2 = [current_p_pos_x + 1/2*pl current_p_pos_x + 1/2*pl];
                y = [current_p_pos_y - 1/2*pl current_p_pos_y + 1/2*pl];
                plot(x1,y,'r','LineWidth',2.0)
                plot(x2,y,'r','LineWidth',2.0)
                ...
                % center
                scatter(optimized_m_pos_x, optimized_m_pos_y, 'b', 'filled');
                hold on;
                ...
                %%%%%%%%%%%%%%% Current Position IK %%%%%%%%%%%%%%%%%%%%%%
                %%%%% Inverse kinematics Solution 1 %%%%%%%%%%%%
                cos_alpha = (-((current_p_pos_x - optimized_m_pos_x)^2 + (current_p_pos_y - optimized_m_pos_y)^2) + link_1^2 + link_2^2) / (2*link_1*link_2);    % () of (2*link_1*link_2) is necessary
                alpha = atan2(sqrt(1 - cos_alpha*cos_alpha), cos_alpha);
                %alpha = atan2(sqrt(1-((-(p_pos_x - optimized_m_pos_x)^2 - (p_pos_y - optimized_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2)^2), (-(p_pos_x - optimized_m_pos_x)^2 - (p_pos_y - optimized_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2);
                c_ik_sol_1_theta_2 = pi - alpha;
                c_ik_sol_1_theta_1 = atan2((current_p_pos_y - optimized_m_pos_y), (current_p_pos_x - optimized_m_pos_x)) - atan2((link_2*sin(c_ik_sol_1_theta_2)), (link_1 + link_2*cos(c_ik_sol_1_theta_2)));
                %c_ik_sol_1_theta_1 = atan2((current_p_pos_y - optimized_m_pos_y), (current_p_pos_x - optimized_m_pos_x)) - atan2(link_2*sin(c_ik_sol_1_theta_2), link_1 + link_2*cos(c_ik_sol_1_theta_2))
                ...
                cos_alpha = (-((current_p_pos_x - optimized_m_pos_x)^2 + (current_p_pos_y - optimized_m_pos_y)^2) + link_1^2 + link_2^2) / (2*link_1*link_2);    % () of (2*link_1*link_2) is necessary
                alpha = - atan2(sqrt(1 - cos_alpha*cos_alpha), cos_alpha);
                %alpha = atan2(sqrt(1-((-(current_p_pos_x - optimized_m_pos_x)^2 - (current_p_pos_y - optimized_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2)^2), (-(current_p_pos_x - optimized_m_pos_x)^2 - (current_p_pos_y - optimized_m_pos_y)^2 + link_1^2 + link_2^2) / 2*link_1*link_2);
                c_ik_sol_2_theta_2 = pi - alpha;
                c_ik_sol_2_theta_1 = atan2((current_p_pos_y - optimized_m_pos_y), (current_p_pos_x - optimized_m_pos_x)) - atan2((link_2*sin(c_ik_sol_2_theta_2)), (link_1 + link_2*cos(c_ik_sol_2_theta_2)));
                %c_ik_sol_2_theta_1 = atan2((optimized_current_p_pos_y - optimized_m_pos_y), (optimized_current_p_pos_x - optimized_m_pos_x)) - atan2(link_2*sin(c_ik_sol_2_theta_2), link_1 + link_2*cos(c_ik_sol_2_theta_2))
    ...
    neighbour_step = neighbour_step / 5;
...
% center
scatter(optimized_p_pos_x, optimized_p_pos_y, 'r', 'filled');
hold on;
